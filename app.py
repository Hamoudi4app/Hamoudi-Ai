...
# مفاتيح — املأها بنفسك
# ---------------------------------------------------
GROQ_API_KEY = "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"
...
def api_chat():
    ...
    try:
        ...
        print("Groq Raw Response:", r.text)
        r.raise_for_status()
...
# ---------------------------------------------------
# API خاص بالصور (يرجع كائنات فيها image و title)
# ---------------------------------------------------
...
def api_images():
    ...
    if "محمد فيصل" in q or "المطور محمد فيصل" in q:
        return jsonify({
            "images": [
                {"image": "/static/1000010259-pica.png", "title": "صورة المطور محمد فيصل"}
            ]
        })
