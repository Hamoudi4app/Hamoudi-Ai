...
def api_chat():
    ...
    try:
        ...
        print("Groq Raw Response:", r.text)  # طباعة الرد الكامل من السيرفر
        r.raise_for_status()
...
# ---------------------------------------------------
# تسجيل الخروج (معدل يرجع للصفحة الرئيسية)
# ---------------------------------------------------
@app.route("/logout")
def logout():
    session.clear()
    return redirect("/")  # يرجع للصفحة الرئيسية اللي فيها login.html
